...
async fn call_nonexistent_tool() {
    ...
    insta::assert_snapshot!(error.to_string(), @"Mcp error: -32603: Tool 'nonexistent_tool' not found");
...
async fn call_tool_wrong_server_prefix() {
    ...
    insta::assert_snapshot!(error.to_string(), @"Mcp error: -32603: Tool 'mtah_service__adder' not found");
...
async fn call_tool_invalid_arguments() {
    ...
    insta::assert_snapshot!(error.to_string(), @"Mcp error: -32603: Tool 'execute' not found");
...
async fn call_tool_no_arguments() {
    ...
    insta::assert_snapshot!(error.to_string(), @"Mcp error: -32603: Tool 'math_service__adder' not found");
